-- Sample Data for SarasEduHub LMS
-- This file populates the database with realistic sample data for testing
...
(1, 'EMP001', 'Platform Administrator', 'full', 'IT');
...
(5, 1, 'completed', 45, NOW() - INTERVAL '10 days'),
(5, 2, 'completed', 42, NOW() - INTERVAL '8 days'),
(5, 3, 'in_progress', 25, NULL),
(6, 1, 'completed', 45, NOW() - INTERVAL '9 days'),
(6, 2, 'completed', 42, NOW() - INTERVAL '7 days'),
(6, 3, 'completed', 50, NOW() - INTERVAL '5 days');
...
(1, 'Monday', '10:00', '11:30', 'Lecture', 'Room 301'),
(1, 'Wednesday', '10:00', '11:30', 'Lecture', 'Room 301'),
(1, 'Friday', '14:00', '15:30', 'Lab Session', 'Lab 205'),
(2, 'Tuesday', '09:00', '10:30', 'Lecture', 'Room 204'),
(2, 'Thursday', '09:00', '10:30', 'Lecture', 'Room 204'),
(3, 'Monday', '13:00', '14:30', 'Lecture', 'Room 105'),
(3, 'Wednesday', '13:00', '14:30', 'Lab Session', 'Lab 102');
...
INSERT INTO assignments (
    ...
    total_marks, created_by
) VALUES
(
    1,
    'Calculus Problem Set 1',
    'Solve differential calculus problems covering limits and derivatives',
    'Complete all 10 problems. Show all working. Submit as PDF.',
    NOW() + INTERVAL '7 days',
    50.00,
    2
),
(
    ...
    'Integration problems and applications',
    'Solve the given integration problems and provide step-by-step solutions.',
...
(
    ...
    'Write a lab report on motion experiments',
    'Include methodology, observations, calculations, and conclusions.',
...
INSERT INTO assignment_submissions (
    ...
    marks_obtained, grade, teacher_feedback, graded_by, graded_at
) VALUES
(
    1,
    5,
    'All problems solved with detailed explanations...',
    'graded',
    45.00,
    'A',
    'Excellent work! Very clear explanations.',
    2,
    NOW() - INTERVAL '2 days'
),
(
...
INSERT INTO tests (
    course_id, title, subject, test_type, scheduled_date, 
    duration_minutes, total_marks, instructions, status,
    camera_required, screen_monitoring, created_by
) VALUES
(
    1,
    'Calculus Mid-term Examination',
    'Mathematics',
    'midterm',
    NOW() + INTERVAL '5 days',
    120,
    100.00,
    'This is a comprehensive test on calculus. Calculator allowed. Show all working.',
    'upcoming',
    true,
    true,
    2
...
(
    ...
    30,
    20.00,
    'Quick quiz on kinematics. No calculators allowed.',
    'upcoming',
    false,
    false,
    3
...
(
    1,
    'descriptive',
    'Solve the integral ∫x²dx and explain your steps.',
    NULL,
    'x³/3 + C',
    10.00,
    2
...
(5, 1, CURRENT_DATE - INTERVAL '5 days', 'present', 2),
(5, 1, CURRENT_DATE - INTERVAL '4 days', 'present', 2),
(5, 1, CURRENT_DATE - INTERVAL '3 days', 'late', 2),
(5, 1, CURRENT_DATE - INTERVAL '2 days', 'present', 2),
(5, 1, CURRENT_DATE - INTERVAL '1 day', 'absent', 2),

(6, 1, CURRENT_DATE - INTERVAL '5 days', 'present', 2),
(6, 1, CURRENT_DATE - INTERVAL '4 days', 'present', 2),
(6, 1, CURRENT_DATE - INTERVAL '3 days', 'present', 2),
(6, 1, CURRENT_DATE - INTERVAL '2 days', 'present', 2),
(6, 1, CURRENT_DATE - INTERVAL '1 day', 'present', 2);
...
INSERT INTO library_items (
    title, item_type, category, subject, description,
    uploaded_by, file_size_kb, pages, average_rating, total_downloads
) VALUES
(
    ...
    'Reference',
    'Mathematics',
    'Comprehensive reference for calculus formulas and theorems',
    2,
    2500,
    150,
    4.7,
...
(
    'Physics Experiments Handbook',
    'Book',
    'Laboratory',
    'Physics',
    'Step-by-step guide for physics laboratory experiments',
    3,
    5800,
    320,
    4.5,
...
(
    ...
    'Tutorial',
    'Chemistry',
    'Video lecture series on organic chemistry fundamentals',
    4,
    450000,
    NULL,
    4.8,
...
INSERT INTO events (
    ...
    end_time, duration_minutes, course_id, instructor_id, status
) VALUES
(
    'Advanced Mathematics - Live Class',
    'live-class',
    'Weekly live session for Q&A and problem solving',
...
(
    'Physics Mid-term Review',
    'workshop',
    'Comprehensive review session before mid-term exam',
...
INSERT INTO announcements (
    title, content, audience, priority, status, created_by, publish_date
) VALUES
(
    'Platform Maintenance Scheduled',
    'The platform will undergo maintenance on January 25th from 2:00 AM to 4:00 AM UTC. Please save your work.',
    'all',
    'high',
    'published',
    1,
...
(
    'New Feature: AI Quiz Generator',
    'Teachers can now use AI to automatically generate quizzes from uploaded materials.',
    'teachers',
    'normal',
    'published',
    1,
...
(
    ...
    'The deadline for Calculus Problem Set 1 has been extended by 2 days due to technical issues.',
    'students',
    'normal',
    'published',
    2,
...
(1, 5, 5, 'Excellent course! Dr. Johnson explains complex concepts very clearly.'),
(1, 6, 5, 'Best mathematics course I have taken. Highly recommended!'),
(2, 5, 4, 'Good course content, but could use more practical examples.'),
(3, 9, 5, 'Perfect introduction to chemistry. Very well structured.');
...
(5, 'New Assignment Posted', 'Calculus Problem Set 1 has been posted. Due in 7 days.', 'assignment', false),
(5, 'Assignment Graded', 'Your submission for Calculus Problem Set 1 has been graded.', 'grade', true),
(6, 'Upcoming Test', 'Calculus Mid-term Examination is scheduled in 5 days.', 'test', false),
(2, 'New Student Enrolled', 'A new student has enrolled in your Advanced Mathematics course.', 'enrollment', true);
